...
import { Star, PlusCircle, MessageSquareText } from "lucide-react"; // Added MessageSquareText for consistency
...
export default function ReviewsPage() {
  ...
  const handleSubmit = (event: FormEvent) => {
    ...
    const newReview: Review = {
      ...
      reviewType: "customer" // Explicitly set as customer review
    };
    ...
    <>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>All logged feedback for NomadX_Agency.</CardDescription>
        </CardHeader>
        <CardContent>
          {reviews.length > 0 ? (
