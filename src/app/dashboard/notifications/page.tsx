...
const initialNotifications: NotificationItem[] = [
  ...
  { id: "4", title: "Monthly Report Ready", description: "October's performance report is available for download.", timestamp: new Date(Date.now() - 3600000 * 24 * 2), read: true, link: "/dashboard/reports" },
  { id: "5", title: "Low Tire Pressure Alert", description: "SUV ABC-789 reported low tire pressure on the front-left tire.", timestamp: new Date(Date.now() - 3600000 * 3), read: false, link: "/dashboard/vehicles/2" },
